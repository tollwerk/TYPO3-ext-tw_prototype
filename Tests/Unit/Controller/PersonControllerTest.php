...
class PersonControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$this->subject = $this->getMock('Tollwerk\\TwPrototype\\Controller\\PersonController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPersonsFromRepositoryAndAssignsThemToView()
	{
		...
		$personRepository = $this->getMock('Tollwerk\\TwPrototype\\Domain\\Repository\\PersonRepository', array('findAll'), array(), '', FALSE);
